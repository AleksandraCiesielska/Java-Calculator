...
public class DescController {
    ...
    @GetMapping("/result")
    public String result(@RequestParam String firstName,  //sprawia że to co wysłaliśmy z formularza zamienia nam to na firstname
        ...
        return "person"; // jaki plik html ma być wyświetlony
    }
